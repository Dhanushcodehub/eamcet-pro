// ============================================================
//  TG EAMCET 2020 – May 12th Evening Shift
...
const questions = {
    ...
    Physics: [
        ...
        {
            id: "p20e_2",
            q: "The acceleration due to gravity is maximum at:",
            options: ["Equator", "Poles", "Mountain top", "Deep sea"],
            ans: 1,
            topic: "Gravitation",
            difficulty: "Easy"
        },
        {
            id: "p20e_3",
            q: "The time period of a satellite orbiting close to Earth is:",
        ...
        {
            id: "p20e_4",
            q: "In Young's double slit experiment, the fringe width depends on:",
            options: ["Wavelength only", "Slit separation only", "Distance from screen only", "All of these"],
            ans: 3,
            topic: "Wave Optics",
            difficulty: "Easy"
        },
        {
            id: "p20e_5",
            q: "The magnetic field inside a straight wire is:",
            options: ["Zero", "Maximum at center", "Increases with distance", "Uniform"],
            ans: 0,
            topic: "Magnetism",
            difficulty: "Easy"
        },
        ...
        {
            id: "p20e_7",
            q: "The number of alpha particles emitted in the decay of U-238 to Pb-206 is:",
            options: ["4", "6", "8", "10"],
            ans: 2,
        ...
        },
        {
            ...
            options: ["Increase speed", "Provide centripetal force", "Reduce friction", "All of these"],
            ans: 1,
        ...
        },
        {
            ...
            options: ["330 m/s", "343 m/s", "360 m/s", "400 m/s"],
            ans: 1,
            topic: "Waves",
            difficulty: "Easy"
        },
        ...
        {
            id: "p20e_12",
            q: "The dielectric constant of vacuum is:",
            options: ["0", "1", "4π", "8.85 × 10⁻¹²"],
            ans: 1,
            topic: "Electrostatics",
            difficulty: "Easy"
        },
        ...
        },
        {
            ...
            options: ["Zero", "Small", "Infinite", "Equal to electron"],
            ans: 0,
        ...
        },
        {
            ...
            options: ["Normal force", "Nature of surfaces", "Both A and B", "Velocity"],
            ans: 2,
            topic: "Friction",
            difficulty: "Easy"
        },
        ...
        },
        {
            ...
            options: ["-13.6 eV", "-3.4 eV", "-1.5 eV", "0 eV"],
            ans: 0,
            topic: "Atoms",
            difficulty: "Easy"
        },
        ...
        },
        {
            ...
            options: ["High temperature", "Low temperature", "Room temperature", "Zero temperature"],
            ans: 0,
            topic: "Nuclear Physics",
            difficulty: "Easy"
        },
    ...
    Chemistry: [
        ...
        {
            id: "c20e_2",
            q: "The oxidation state of S in H₂SO₄ is:",
            options: ["+2", "+4", "+6", "+8"],
            ans: 2,
