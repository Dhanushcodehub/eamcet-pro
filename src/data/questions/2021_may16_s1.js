// ============================================================
//  TG EAMCET 2021 – May 16th Morning Shift
...
const questions = {
    ...
    Physics: [
        {
            id: "p21f_1",
            q: "The work done in moving a charge in an electric field depends on:",
            options: ["Path taken", "Initial and final positions", "Speed of charge", "Mass of charge"],
            ans: 1,
        ...
        {
            id: "p21f_2",
            q: "The displacement of a particle executing SHM is maximum at:",
        ...
        {
            id: "p21f_3",
            q: "The orbital speed of a satellite depends on:",
        ...
        {
            id: "p21f_4",
            q: "In Young's double slit experiment, the fringe width is:",
        ...
        {
            id: "p21f_7",
            q: "The number of neutrons in a nucleus is:",
            options: ["A", "Z", "A - Z", "A + Z"],
            ans: 2,
        ...
        {
            id: "p21f_10",
            q: "The speed of sound in air decreases with:",
        ...
        {
            id: "p21f_12",
            q: "The capacitance increases when:",
            options: ["Distance between plates increases", "Dielectric constant decreases", "Area decreases", "Charge decreases"],
            ans: 0,
            topic: "Electrostatics",
            difficulty: "Easy"
        },
        ...
        {
            id: "p21f_17",
            q: "The pressure of an ideal gas is:",
            options: ["Due to molecular collisions", "Due to molecular attraction", "Due to molecular repulsion", "None"],
            ans: 0,
    ...
    Chemistry: [
        {
            id: "c21f_1",
            q: "The number of moles in 11.2 L of O₂ at STP is:",
        ...
        {
            id: "c21f_12",
            q: "The solubility product of AgI is 8.3 × 10⁻¹⁷. Its solubility is:",
            options: ["9.1 × 10⁻⁹", "8.3 × 10⁻⁹", "1.8 × 10⁻⁸", "2.7 × 10⁻⁸"],
            ans: 0,
            topic: "Ionic Equilibrium",
            difficulty: "Medium"
        },
        ...
        },
        {
            ...
            options: ["C₅₅H₇₂O₅N₄Mg", "C₅₅H₇₂O₅N₄Mg", "C₅₅H₇₂O₅N₄Mg", "C₅₅H₇₂O₅N₄"],
            ans: 0,
            topic: "Biomolecules",
            difficulty: "Hard"
        },
        ...
        {
            id: "c21f_26",
            q: "The value of R (gas constant) is:",
            options: ["0.0821 L atm/mol·K", "8.314 J/mol·K", "Both A and B", "Neither"],
            ans: 2,
            topic: "Mole Concept",
            difficulty: "Easy"
        },
        {
            id: "c21f_27",
            q: "The electronegativity decreases down the group due to:",
    ...
    Mathematics: [
        ...
        {
            id: "m21f_6",
            q: "The equation of line with slope 11/12 and y-intercept 13 is:",
            options: ["y = 11x", "y = 11x + 13", "y = 12x + 11", "y = 11x - 13"],
            ans: 1,
