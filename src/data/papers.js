...
//       id: `p23_${i+1}`,
//       q: `Physics Question ${i+1} covering Kinematics & Mechanics`,
//       options: [`Option A`, `Option B`, `Option C`, `Option D`],
//       ans: i % 4,
//       topic: 'Physics',
//       difficulty: ['Easy','Medium','Hard'][i%3]
//     })),
//     Chemistry: Array.from({length: 40}, (_, i) => ({
//       id: `c23_${i+1}`,
//       q: `Chemistry Question ${i+1} covering Organic & Inorganic concepts`,
//       options: [`Option A`, `Option B`, `Option C`, `Option D`],
//       ans: (i+1) % 4,
//       topic: 'Chemistry',
//       difficulty: ['Easy','Medium','Hard'][i%3]
//     })),
//     Mathematics: Array.from({length: 80}, (_, i) => ({
//       id: `m23_${i+1}`,
//       q: `Mathematics Question ${i+1} covering Calculus, Algebra & Geometry`,
//       options: [`Option A`, `Option B`, `Option C`, `Option D`],
//       ans: (i+2) % 4,
//       topic: 'Mathematics',
//       difficulty: ['Easy','Medium','Hard'][i%3]
...
// const ps = [
//   { id: '2023_full', year: '2023', label: 'TG EMCET 2023 – Full Paper', questions: 160, duration: 180, subjects: ['Physics', 'Chemistry', 'Mathematics'], shift: 'Morning' }
// ];

// export const QUESTION_BANK = qb;
// export const PAPER_SETS = ps;


// ============================================================
//  TG EAPCET (TS EAMCET) Question Bank & Paper Sets
//  Source: TG EAPCET 2025 – 2nd May Morning Shift (Official)
...
const ps = [
  ...
  // ── placeholder slots for other 2025 shifts (add questions when available) ──
  {
    id: "2025_may2_s2",
    year: "2025",
  ...
  },
  {
    id: "2025_may3_s1",
    year: "2025",
    label: "TG EAPCET 2025 – May 3rd Morning Shift",
    questions: 160,
    duration: 180,
    subjects: ["Physics", "Chemistry", "Mathematics"],
    shift: "Morning"
  ...
  // ── 2023 paper (keep your existing data here) ──
  {
    id: "2023_full",
    year: "2023",
